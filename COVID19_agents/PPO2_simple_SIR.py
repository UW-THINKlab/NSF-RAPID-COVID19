...
model = PP02(MlpPolicy,env, tensorboard_log="./DQN_SIR_tensorboard/")
...
titleStr= ("PP02 agent after %d training steps" % (numTimesteps))
plt.title(titleStr)

# save figure to results folder
saveStr= ("../Results/PP02_simple_SIR_results%d.png" % (numTimesteps))
fig.savefig(saveStr)
