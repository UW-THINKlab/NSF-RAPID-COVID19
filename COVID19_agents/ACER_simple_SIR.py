...
model = ACER(MlpPolicy,env, tensorboard_log="./DQN_SIR_tensorboard/")
...
titleStr= ("ACER agent after %d training steps" % (numTimesteps))
plt.title(titleStr)

# save figure to results folder
saveStr= ("../Results/ACER_simple_SIR_results%d.png" % (numTimesteps))
fig.savefig(saveStr)
